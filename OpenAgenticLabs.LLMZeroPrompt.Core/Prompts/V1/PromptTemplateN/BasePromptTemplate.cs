...
//using OpenAgenticLabs.LLMZeroPrompt.Elevate.Core.ChainsN;
...
///// </summary>
//public partial class BasePromptTemplate : object, IBasePromptTemplate, IChain
//{
//    /// <summary>
...
//    ///// </summary>
//    public virtual BasePromptTemplateInputCollection PromptTemplateCollection { get; }
...
//        this.PromptTemplateCollection = new BasePromptTemplateInputCollection();
//        this.Tags = new List<string>();
//        this.Metadata = new Dictionary<string, object>();

//    }

//    public static BasePromptTemplate New(BasePromptTemplateInput promptTemplate)
//    {
//        var newBasePromptTemplate = new BasePromptTemplate(promptTemplate);
...
//    public BasePromptTemplate(string promptTemplateString)
//    {
//        this.Metadata = new Dictionary<string, object>();
//        this.PromptTemplateCollection = new BasePromptTemplateInputCollection(promptTemplateString);
//        this.Tags = new List<string>();
//        this.Metadata = new Dictionary<string, object>();
...
//    public BasePromptTemplate(BasePromptTemplateInput promptTemplate)
//    {
//        this.Metadata = new Dictionary<string, object>();
//        this.PromptTemplateCollection = new BasePromptTemplateInputCollection(promptTemplate);
//        this.Tags = new List<string>();
//        this.Metadata = new Dictionary<string, object>();
...
//    /// </summary>
//    /// <returns></returns>
//    public virtual BasePromptTemplateInputCollection GetMessages()
//    {
...
//    /// <param name="inputVariables"></param>
//    /// <returns></returns>
//    public virtual BasePromptTemplateInputCollection GetMessages(Dictionary<string, string> promptTemplateVariables)
//    {
