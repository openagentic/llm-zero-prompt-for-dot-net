...
/// </summary>
public enum LLMTaskDescriptionInputFormats
{
    ...
    BinaryDocument = 38, ///<summary>A binary document file.</summary>
    SpreadsheetCsv =39, ///<summary>A CSV spreadsheet.</summary>
    Double = 40,    ///<summary>A number.</summary>
    JsonArrayOfKeyValuePairs = 43, ///<summary>A json array of key value pairs.</summary>
    ...
    PowerShellScriptRequirements = 50, ///<summary>Azure PowerShell script requirements</summary>
